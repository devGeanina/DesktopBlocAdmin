...
public class Constants {
    ...
    public enum EXPENSE_TYPE {
        ...
        MONTHLY((short) 1, "Monthly"), YEARLY((short) 2, "Yearly"), BUILDING_MAINTAINANCE((short) 3, "Building Maintainance"), COMMON_FOND((short) 4, "Common fond"), OTHER((short)5, "Other");
    ...
    public enum HOUSEHOLD_REQUEST_TYPE {
        ...
        COMPLAINT((short) 1, "Complaint"), DOC_RELEASE((short) 2, "Document release"), OTHER((short)3, "Other");
    ...
    public enum BUDGET_TYPE {
        ...
        MONTHLY_HOUSEHOLD((short) 1, "Monthly Household"), REPAIRS((short) 2, "Repairs"), EMPLOYEE_SALARY((short) 3, "Employee Salary"), WORKING_CAPITAL((short) 4, "Working capital"), OTHER((short)5, "Other");
